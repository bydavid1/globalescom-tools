<template>
    ...
    <CContainer fluid>
        <CRow v-for="(item, i) in perspectives" :xs="{ gutter: 1 }" :key="i" style="font-size: 12px;" class="mt-2">
            <CCol xs="2">
                <CCard style="min-height: 9rem; width: 9rem; display: flex; justify-content: center; align-items: center;"
    ...
    <CContainer class="my-4">
        <CRow class="justify-content-end align-items-center">
            <CCol xs="4" class="d-flex align-items-center justify-content-end" style="height: 2rem;">
